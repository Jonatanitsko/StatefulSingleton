...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		// when the Manager ends. This requires the binary to capture os.Signals.
	...
	// Register our StatefulSingleton controller
	if err = (&controllers.StatefulSingletonReconciler{
